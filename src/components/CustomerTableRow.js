...
export default class CustomerTableRow extends Component {
    ...
    deleteCustomer() {
        axios.delete('http://localhost:8070/customers/delete-customer/' + this.props.obj._id)
            .then((res) => {
        ...
        return (
            ...
            <tr>
                ...
                <td>
                    ...
                    <Button onClick={this.deleteCustomer} size="vh" variant="danger">
